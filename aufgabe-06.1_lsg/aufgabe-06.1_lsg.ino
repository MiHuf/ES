// Aufgabe 6.1, Stand von 2015-06-22
...
// Pin Constants
const int pinCS0 = 10;                      // SPI: Chip Select 0  <<< for LCD-Display
const int pinCS1 = 4;                       // SPI: Chip Select 1  <<< for Wireless-Shield
// const int pinCS2 = 52;                   // SPI: Chip Select 2
const int pinDC = 5;                        // SPI: D/C = Data / Control
const int pinRST = 6;                       // SPI: RST = Reset LCD-Display
...
void setup() {
  ...
  analogWrite(pinLcdLed, 255);              // switch LED on LCD
...
void printStringCentered(int y, String s) {
  // Druckt den String S zentriert in einer Zeile
  int x0;
  int len = s.length();
  if (len > 14) {
    return;
